    ...
    <footer className="bg-white dark:bg-gray-950 border-t border-gray-200 dark:border-gray-800 transition-colors">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8 border-b border-gray-200 dark:border-gray-800 pb-8">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a 
                href="https://github.com/PatilAbhayVijay" 
                target="_blank" 
              ...
              <a 
                href="mailto:abhaypatil@example.com" 
        ...
        <div className="flex flex-col md:flex-row justify-between items-center text-sm text-gray-500 dark:text-gray-400">
          <p>&copy; {new Date().getFullYear()} Patil Abhay Vijay. All rights reserved.</p>
          
          <Link 
            to="home" 
            smooth={true} 
            duration={500} 
            className="mt-4 md:mt-0 p-3 bg-gray-100 dark:bg-gray-800 rounded-full hover:bg-blue-100 dark:hover:bg-gray-700 text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 cursor-pointer transition-all animate-bounce"
